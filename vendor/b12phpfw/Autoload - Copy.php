...
// http://dev1:8083/fwphp/glomodul/blog/index.php?i/posts/ -> error
  ...
  function autoloader(string $nscls) 
  {
    try {
      ...
      $module_dir   = basename(dirname($nscls_linfmt)) ; //eg post is unique module name
          ...
          if ($clsname === 'Posts'): echo '<br>stack_trace:<br>'; print_r($this->pp1->stack_trace) ; endif ;
                          echo '</pre>'; 
                          }
      switch (true) { 
      // *********************************
      ...
      case  $clsname === 'Tbl_crud': //for compound module eg blog may be in different nodules
        ...
        switch (basename($this->pp1->module_path)) { 
