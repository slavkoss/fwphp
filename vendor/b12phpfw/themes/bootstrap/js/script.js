...
function codepenPrefill(code, codeExample) {
  code.each(function() {
    ...
    var data = {
      ...
      js_library         : "",
      html_classes       : "",
      css_external       : "https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css",
      js_external        : "https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/js/bootstrap.bundle.min.js",
      template           : true
    };
