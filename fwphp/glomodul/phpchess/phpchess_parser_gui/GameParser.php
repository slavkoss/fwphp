...
class GameParser
{
    ...
    private $game;
    private $fen;
    public $fenParser0x88; //was private
    ...
    private function addParsedProperty() {$this->game[CHESS_JSON::GAME_METADATA][CHESS_JSON::MOVE_PARSED] = 1; }

    private function parseMoves(&$moves) {foreach ($moves as &$move) {$this->parseAMove($move);}}
    ...
    private function getStartFen() { return $this->game[CHESS_JSON::FEN]; }
