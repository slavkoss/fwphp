...
// see https://www.chessgames.com/perl/chessgame?gid=1977101  Siegbert Tarrasch vs Allies 1915
              /*$chess->header('White', 'Siegbert Tarrasch');
              $chess->header('Black', 'Allies');
              $chess->header('Result', '1-0, 35 moves');
              $chess->header('Opening', 'Bird Opening: Dutch Variation (A03)');
              $chess->header('when', '1914');
              $chess->header('where', 'Naples'); */
