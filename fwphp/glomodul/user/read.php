...
if ( null == $id ) { $this->Redirect_to($pp1->h) ; }

//$Tbl_ crud = new Tbl_ crud ; $c ursor = $Tbl_ crud->r r($this, $id) ;
$cursor = (new Tbl_crud)->rr($this, $id) ;
      ...
      <div class="container">
        <div class="row">
          ...
          <h1><i class="fas fa-user text-success mr-2" style="color:#27aae1;"></i>
             Profile of admin username <?=$r->username?>
          </h1>
    ...
    <section class="container py-2 mb-4">
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          Admin id <?=$id?>, name :<br /><?=$r->aname?><br />
          <br />Email Address :<br /><?php echo $r->email;?>
