<?php
/**
 * Date: 22.09.2017   * Time: 10:42
 */
//http://dev1:8083/fwphp/glomodul/z_examples/02_mvc/wecrm/
namespace router;
...
class Router
{
    ...
    public static function init(){
        $protocol = 'http'; //isset($_SERVER['HTTPS'])
          //||(isset($_SERVER['HTTP_X_FORWARDED_PROTO']) && $_SERVER['HTTP_X_FORWARDED_PROTO'] === "https")
          //? 'https' : 'http';
        
        $_SERVER['SERVER_PORT'] === "80" ? $serverPort = "" : $serverPort = ":" . $_SERVER['SERVER_PORT'];
        
        $GLOBALS["ROOT_URL"] = $protocol . "://" . $_SERVER['SERVER_NAME'] . $serverPort 
          . strstr($_SERVER['PHP_SELF'], $_SERVER['ORIGINAL_PATH'], true);
    ...
    public static function route_auth($method, $path, $authFunction, $routeFunction) {
        ...
        self::$routes[$method][$path] = array(
           "authFunction" => $authFunction, "routeFunction" => $routeFunction);
    }
    ...
    public static function out_routes() {
       echo '<pre>Router::$routes='; print_r(self::$routes); echo '</pre>';
       //return self::$routes ;
    }
