...
/* http://dev/                        http://localhost/ je zwamp doc root
   J:\dev_web\htdocs\index_zwamp.php  J:\zwamp\vdrive\web\index.php
...
//
//$wampConfFile = realpath($mdpath.'/../conf/index_zamp.conf.php');
$wampConfFile = 'index_zwamp_conf.php' ;
        //bilo:  ../wampmanager.conf 
if (!is_file($wampConfFile))
    die ("Ne mogu pročitati putanju \$wampConfFile=$wampConfFile, upišite točan path u varijablu \$wampConfFile u skripti $fle");
//
require_once("index_zwamp_conf.php"); 
...
$pgbody = <<< EOPGBODY
  ...
  <!-- SW verzije -->
   ...
   <dl class="xxcontent">
      ...
      ${oraclexeVersion} &nbsp;<a href='http://{$txtlang[$jezik]['docoraxe']}'>Docs</a>
...
// *********************************************
ob_start();
   include('index_MongoDB.html');
$pgbody2 = ob_get_contents();
ob_end_clean();
...
<p>Z je npr J:\zwamp\vdrive, subst Z: &quot;J:\zwamp\vdrive&quot;<br>
  ...
  host system to have Visual C++ installed - MSVC11 (Visual C++ 2012) on Win NT SSPC 6.3 build 9200 (Win 8.1 Business Edition) AMD64<br>
...
echo '<br /><br />This script is from WAMP: reads index_zamp.conf.php in $wampConfFileContents='; print_r($wampConfFileContents); 
?>
8.10.2014
</p>
<p>&nbsp;</p>
