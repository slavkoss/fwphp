            ...
            <div class="col-md-6 mx-auto">
                ...
                ?>
                    ...
                    <form action="<?php echo(URLROOT); ?>/process/p_edit_profile.php" method='POST' enctype="multipart/form-data">
                        ...
                        <input type='name' name="name" value="<?php echo($user->user_name); ?>" class="form-control form-control-lg <?php echo(isset($err['name_err'])) ? 'is-invalid' : ''; ?>">
                        <span class="invalid-feedback"><?php echo($err['name_err']); ?></span>
                    </div>

                    <div class="form-group">
                        <label for='username'>Username: <sup>*</sup></label>
                        <input type='text' name="username" value="<?php echo($user->user_name); ?>" class="form-control form-control-lg <?php echo(isset($err['username_err'])) ? 'is-invalid' : ''; ?>">
                    ...
                    <div class="form-group">
                        <label for='url'>Your id (Website URL): <sup>*</sup></label>
                        <input type='text' name="website" value="<?php echo($user->user_id); ?>" class="form-control form-control-lg <?php echo(isset($err['website_err'])) ? 'is-invalid' : ''; ?>">
                         <span class="invalid-feedback"><?php echo($err['website_err']); ?></span>
                    </div>
                    
                    <!-- URLROOT.'/images/'-->
                    <div class="form-group w-50" id="imageBox" >
                        <img src="<?= '/zinc/img/'.$user->image; ?>" alt="" class="img-responsive w-100">
