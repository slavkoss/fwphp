<?php
// J:\awww\apl\dev1\01apl\01mastdet\Db.php
...
define('DATABASE', getenv('USERDOMAIN', true) ?: getenv('USERDOMAIN').'/XE:pooled');
...
// Run a SQL or PL/SQL statement
    ...
    // USSAGE: $db->execute('SELECT COUNT(*) rrtbl FROM EMPLOYEES'
    //              , 'getrrtbl', array()); // $action, $bindvars
    //         $rrtbl = $db->fetchRow()['RRTBL'];
    ...
    public function execFetchPage($sql, $action
