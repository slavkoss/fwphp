          ...
          <div class="card">
            ...
            <table class="table table-striped">
              <thead class="thead-inverse">
                <tr>
                  <th>#</th><th>User Edit</th><th>Email</th><th>Date Registered</th><th>Del</th><th>id</th>
        ...
        $ii=0; while($row=$stmt->fetch(PDO::FETCH_NUM)) // FETCH_ASSOC, FETCH_OBJ...
        {
         ...
         <td align="center"><a href="delete.php?id=<?php echo $row[0]; ?>" 
          ...
          <!--td><?php //echo $row[4]; ?></td-->
             ...
             <!--a href="update_usr.php" class="btn btn-secondary">
                    <i class="fas fa-angle-double-right"></i> Details
             </a-->

          <!--td>  <a href="update_usr.php?eid=<?php //echo $row[0]; ?>"
                title="Edit"><img src="/zinc/img/edit.png" width="20px" />
                </a></td-->
                
           <!--td align="center"><a href="login.php?id=<?php //echo $row[0]; ?>"
              title="LOGIN">PRIJAVA</a></td-->
          <!--td align="center"><a href="logout.php" title="LOGOUT">ODJAVA</a></td-->
