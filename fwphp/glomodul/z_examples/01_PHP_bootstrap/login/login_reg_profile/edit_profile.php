        ...
        <div class="row">
            ...
            <div class="col-md-6 mx-auto">
                ...
                ?>
                    ...
                    <form action="<?php echo(MODULE_URL); ?>p_edit_profile.php" method='POST' enctype="multipart/form-data">
                         <div class="form-group">
                        <label for='name'>Name: <sup>*</sup></label>
                        <input type='name' name="name" value="<?php echo($user->aname); ?>" class="form-control form-control-lg <?php echo(isset($err['aname_err'])) ? 'is-invalid' : ''; ?>">
                        <span class="invalid-feedback"><?php echo($err['aname_err']); ?></span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type='email' name="email" value="<?php echo($user->user_email); ?>" class="form-control form-control-lg <?php echo(isset($err['email_err'])) ? 'is-invalid' : ''; ?>">
                         <span class="invalid-feedback"><?php echo($err['email_err']); ?></span>
                    </div>

                    <div class="form-group">
                        <label for='website'>Website URL: <sup>*</sup></label>
                    ...
                    <div class="form-group">
                        <label for='id'>Your id (User id): <sup>*</sup></label>
                        <input type='text' name="id" value="<?php echo($user->id); ?>" class="form-control form-control-lg <?php echo(isset($err['id_err'])) ? 'is-invalid' : ''; ?>">
                         <span class="invalid-feedback"><?php echo($err['id_err']); ?></span>
                    </div>
                    
                    <!-- MODULE_URL.'/images/'-->
                    <div class="form-group w-50" id="imageBox" >
                        <img src="<?= '/zinc/img/'.$user->aimage; ?>" alt="" class="img-responsive w-100">
                    ...
                    <div class="form-group" id='imageUpload'>
                        ...
                        <div class="row">
                            ...
                            <div class='col'>
                                ...
                                <a href="<?php echo(MODULE_URL); ?>/change_password.php" class="btn btn-light btn-block">Wanna Change Password? </a>
