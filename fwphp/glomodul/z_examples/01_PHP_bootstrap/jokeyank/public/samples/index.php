...
try {
  ...
  $pdo->query('CREATE USER \'ijdb_sample\'@\'localhost\' IDENTIFIED BY \'joke\'');

  //only one sample should be used at once.
  ...
  if (file_exists('../../database_DDL_MOJ.sql')) {
    $pdo->exec(file_get_contents('../../database_DDL_MOJ.sql'));
  }
