...
/*
  J:\awww\www\fwphp\glomodul\phpchess\p_Util.php (3 hits)
7:   p ublic s tatic f unction foreignLettersToEnglishLetters($text)
28:  p ublic s tatic f unction titleCaseIfCurrentlyAllCaps($text)
37:  p ublic s tatic f unction normalizePlayerName($name)
*/