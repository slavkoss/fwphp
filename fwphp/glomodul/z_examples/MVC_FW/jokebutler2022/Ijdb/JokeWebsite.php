<?php
namespace Ijdb; // Internet Joke Database -  website that displays DB of jokes.
class JokeWebsite implements \Ninja\Website {
    ...
    public function __construct() {
        $pdo = new \PDO('mysql:host=localhost;dbname=z_yoke;charset=utf8mb4', 'root', '');
    ...
    public function getController(string $controllerName): ?object //return type hint: either an object or null
    {
      ...
      // null if there is no controller for $controllerName :
