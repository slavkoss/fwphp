...
if(isset($_POST['request-activate-account'])){
    ...
    if(!count($errors)){
        ...
        $stmt = $objDB->prepare(
            'UPDATE admins SET reset_code=? WHERE email=?'
        );
        ...
        $stmt->bind_param('ss', $code, $email);
         ...
         if($stmt->execute()){
            ...
            $message = "Hi! You requested account verification. You need to click here to <a href='".MODULE_URL."p_account_verify.php?code=$code'>activate your account.</a>";
