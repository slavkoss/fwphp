<?php
// J:\dev_web\htdocs\index_lang_ikone.inc.php
...
$projectsListIgnore = array ('.','..','inc','z_bckup'
    ,'.idea'
);
$jezik = 'hr';
//
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//       ADRESE: URL, PATHS: APSOLUTNI & REL
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
//
// -----------------~~~~~~~~~~~~~~~~~~~~~-----------------------
// 2.2 Programi-Projekti (mape aplikacija) - FORMIRANJE LINKOVA 
// --------------------------------------~~~~~~~~~~~~~~~~~~~~~--
...
//----------------------------------------------
// 2.5 konfig. datoteka - podaci o instaliranom itd
//----------------------------------------------
$fp = fopen($wampConfFile,'r');
$wampConfFileContents = fread ($fp, filesize ($wampConfFile));
$wampConfFileContents = '<pre>'.$wampConfFileContents.'</pre>';
fclose ($fp);
//----------------------------
...
preg_match('|oraclexeVersion = (.*)\n|',$wampConfFileContents,$result);
$oraclexeVersion  = str_replace('"','',$result[1]);
//
