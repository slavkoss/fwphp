<?php
// http://sspc2:8083/fwphp/glomodul/z_examples/phpchess/
...
$chess = new Chess();
                          //while (!$chess->gameOver()) {
                             //$m oves = $chess->m oves();
                             //$m ove = $m oves[random_int(0, count($m oves) - 1)];
                             //$chess->m ove($m ove);
                          //}
$moves = '
...
//echo echo (new UnicodeOutput())->render($chess) . '<br />' ;
echo '<pre>'; echo (new AsciiOutput())->render($chess) . '<br />'; echo '</pre>' ;