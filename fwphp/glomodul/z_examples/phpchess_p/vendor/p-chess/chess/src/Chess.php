    ...
    public function move($sanOrArray): ?Move
    {
        ...
        if (\is_string($sanOrArray)) {
            foreach ($moves as $move) {
                $this->moveToSAN($move);
                        //Bxb5 echo '<br />$sanOrArray=<pre>'; print_r($sanOrArray); echo '</pre>' ;
                        if ($sanOrArray === 'Bxb5') {
                           echo '<br />$move->san=<pre>'; print_r($move->san); echo '</pre>' ;
                        }
        ...
        if ($moveObject === null) {
            return null;
                        ...
                        //echo '<br />$moveObject=<pre>'; print_r($moveObject); echo '</pre>' ;
