...
function()
{
  //https://www.w3schools.com/jquery/jquery_ref_post.asp
  var v_key_pressed = 0 ;
  ...
  $("#add_form").submit(function(evt){
     ...
     /*<!-- ************************************************************
       3. Extract user changed flds values for U p d a t e  Button  F n
          This code executes after each char typed !
    ************************************************************ -->*/
       ...
       $(".delete").on('click', function(){ 
          ...
          if(confirm('Are you sure you want to delete id=' + v_id)) {
              $.post( "tbl2_js_ctrl.php", {id: v_id, deleterow: 'deleter'}
                    ...
                    //echo "<a idtofrm='". $row['id']."'"." class='title-link' href='javascript:void(0)'>{$row['title']}</a></td>" ;
