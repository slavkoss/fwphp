 ...
 */
    ...
    class MERCEDES_T_TIP_DOCPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('TIP DOC');
            $this->SetMenuLabel('TIP DOC');
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('opis_edit');
    ...
    try
    {
        $Page = new MERCEDES_T_TIP_DOCPage("MERCEDES_T_TIP_DOC", "T_TIP_DOC.php", GetCurrentUserPermissionsForPage("MERCEDES.T_TIP_DOC"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("MERCEDES.T_TIP_DOC"));
