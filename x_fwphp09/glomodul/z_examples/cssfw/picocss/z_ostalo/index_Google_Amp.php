...
<html lang="en" ⚡<?=isset($_GET['theme']) ? ' data-theme="' . $_GET['theme'] . '"' : '' ?>>
  ...
  <head>
    ...
    <title>Google Amp example • Picocss</title>
    ...
    <!-- Picocss custom build inlined for Google AMP -->
    <style amp-custom>
    <?php
    include("J:/awww/www/vendor/b12phpfw/themes/picocss/pico.google-amp.min.css");
    echo '<br>';
    ?>
    </style>
  </head>
