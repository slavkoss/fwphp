  ...
  */
     ...
     , array $other=[]): object
  {
     ...
     if (isset($pp1->shared_dbadapter_obj)) self::$utldb = $pp1->shared_dbadapter_obj ;
                ...
                if ('' and isset($_POST["submit_add_song"])) {
    ...
    //if($cursor){$_S ESSION["SuccessMessage"]="Admin with the name of ".$Name." added Successfully";
    //}else { $_S ESSION["ErrorMessage"]= "Something went wrong (cre admin). Try Again !"; }
  ...
  static public function uu( object $pp1, array $other=[]): string // *************** u u (
  {
    // 1. S U B M I T E D  F L D V A L S - P R E  U P D A T E
      ...
      //$_S ESSION["get_submitted_uu"] = $get_submitted_uu ;
