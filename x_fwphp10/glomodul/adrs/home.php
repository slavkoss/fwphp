...
<div class="container">
    ...
    <p>Eg adrs module in same named folder :</p>
                    <p>Path (Oper. System adress) &lt;?=$pp1-&gt;module_relpath?&gt; below site root = <?=$pp1->module_relpath?></p>
    <p>
    Path (web 
    adress)
    &lt;?=$pp1-&gt;module_url?&gt; 
 ...
 <li>After delete row in Home_ctr : utl::Redirect_to($pp1-&gt;module_url.QS.'i/rt/') 
    ; //to read_ tbl
    <br>
  ...
  <li>
    In&nbsp; upd_row_frm.php utl::Redirect_to($pp1-&gt;module_url.QS.'i/rt/');<br>
